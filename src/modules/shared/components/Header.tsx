...
import MenuHamburger from "@shared/svgs/MenuHamburger";
import Close from "@shared/svgs/Close";
import ArrowNext from "@shared/svgs/ArrowNext";
import { useAuthStore } from "@auth/stores/authStore"; // Importamos el store de auth
import iconUser from "@/assets/icons/icon-user.svg";
import iconEmpresa from "@/assets/icons/icon-empresa.svg";
...
import dataEmpresa from "@company/json/dashboardEmpresa.json";
import dataAdmin from "@admin/json/dashboardAdmin.json";
import Company from "@shared/svgs/Company";
import Tag from "@shared/svgs/Tag";
import OffCanvas from "@shared/constructors/OffCanvas"; // Importamos OffCanvas
import EditProfile from "./EditProfile"; // Importamos EditProfile
import iconReservation from "@/assets/icons/icon-reserva.svg";
