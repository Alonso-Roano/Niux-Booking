...
import openEye from "/images/icons/open-eye.svg";
  ...
  const validatePassword = (password: string, confirmPassword: string) => {
    setPasswordCriteria({
      ...
      match:
        password !== "" &&
        confirmPassword !== "" &&
        password === confirmPassword, // Verifica si las contraseñas coinciden
    });
  };
    ...
    try {
      ...
      if (err?.response?.status === 400 && err?.response?.data?.errors?.Email) {
        ...
        if (emailErrors.includes("The Email field is required.")) {
          ...
          emailErrors.includes("The Email field is not a valid e-mail address.")
        ) {
        ...
        setError(
          err instanceof Error ? err.message : "Hubo un error en el registro"
        );
      }
    }
  };
        ...
        <div className="w-full lg:w-1/2 p-8 lg:pt-5 flex flex-col justify-center">
          ...
          <Link to="/">
            <div className="flex gap-2 justify-center items-center">
              <Logoniux10 />
              <span className="font-medium text-xl text-[#484748]">
                NIUXBOOKING
              </span>
            </div>
          </Link>
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm mt-2 grid grid-cols-2 gap-2">
                ...
                >
                  {passwordCriteria.uppercase ? "✔" : "✘"} Al menos una letra
                  mayúscula
                </p>
                <p
                  className={`flex items-center gap-2 ${
                ...
                >
                  {passwordCriteria.special ? "✔" : "✘"} Al menos un carácter
                  especial (&%$#!@)
                </p>
                <p
                  className={`flex items-center gap-2 ${
                ...
                <p
                  className={`flex items-center gap-2 ${
                    passwordCriteria.match ? "text-green-500" : "text-red-500"
                  }`}
                >
